...
export async function setBarbers() {
    ...
    activeBarbers.forEach(barber => {
        ...
        barberCard.style.cssText = `
            background: url(${barber.imagePath}) no-repeat center/cover;
        `;
        ...
        barbersContent && barbersContent.appendChild(barberCard);
        ...
        const instagram = createAnchorWithSvg(barber.instagramLink, instagramSvg);
        ...
        const x = createAnchorWithSvg(barber.xLink, xSvg);
